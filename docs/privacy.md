...
0600. On Windows, use a private user-profile storage directory with appropriate inherited ACLs;
ACL isolation still requires native acceptance verification.
